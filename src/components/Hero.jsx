export default function Hero() {
  return (
    <section className="relative min-h-screen bg-gradient-to-br from-[#021B13] via-[#043D2B] to-[#065F46] text-white overflow-hidden">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="mt-8 flex gap-4">
              <a
                href="/plant"
                className="bg-accent px-6 py-3 rounded-full text-lg hover:scale-105 transition"
              >
                Plant Now
              </a>
